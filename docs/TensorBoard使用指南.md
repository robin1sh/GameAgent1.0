...
python3 train/train_ppo_mario.py \
...
python3 train/train_ppo_jumper.py \
    --total-timesteps 10000000 \
    --n-envs 10 \
    --exp-id jumper_v1
...
screen -S mario_train
cd /ai/MarioRL
python3 train/train_ppo_mario.py --exp-id mario_v1 --total-timesteps 10000000
# Ctrl+A D 分离

# ③ 服务器：启动 Jumper 训练
screen -S jumper_train
python3 train/train_ppo_jumper.py --exp-id jumper_v1 --total-timesteps 10000000
# Ctrl+A D 分离
